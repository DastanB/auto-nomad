...
ALLOWED_HOSTS = ["localhost", "0.0.0.0", "127.0.0.1"] + env.list("DJANGO_ALLOWED_HOSTS", default=["example.com"])
...
# endregion
DEFAULT_FILE_STORAGE = "config.settings.test.MediaRootS3Boto3Storage"
...
LOGGING = {
    ...
    "handlers": {
        ...
        'logstash': {
            ...
            'fqdn': False,
            'tags': ['django', 'test', 'nomad_auto_advert'],  # список тег.
        },
    },
    "loggers": {
        "nomad_auto_advert": {
