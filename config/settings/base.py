...
)  # (nomad_auto_advert/config/settings/base.py - 3 = nomad_auto_advert/)
APPS_DIR = ROOT_DIR.path("nomad_auto_advert")
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'nomad_auto_advert.microservices.authorization.CapsTokenAuthentication',
        'nomad_auto_advert.microservices.authorization.CapsPlainTokenAuthentication',
    ),
...
ADMINS = [("""Bakhtiyar Dabylov""", "bdabylovb@gmail.com")]
# https://docs.djangoproject.com/en/dev/ref/settings/#managers
MANAGERS = ADMINS

# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["nomad_auto_advert.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
...
# Microservices ...
# ------------------------------------------------------------------------------
COMMON_API_KEY = env("COMMON_API_KEY")
SELF_SERVICE_NAME = env("SELF_SERVICE_NAME")
