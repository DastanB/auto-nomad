...
class AdvertViewSet(MultiSerializerViewSetMixin,
    ...
    def get_queryset(self):
        ...
        qs = self.queryset.filter(user=self.request.user).select_related(
...
class AdvertSearchView(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        qs = Advert.objects.all().select_related(
            'car',
...
# class ModerateAdvertViewSet(MultiSerializerViewSetMixin,
#                             generics.ListAPIView,
#                             generics.RetrieveAPIView,
